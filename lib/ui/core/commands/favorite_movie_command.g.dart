...
String _$favoriteMovieCommandHash() =>
    r'582e8155d1d95313fa7d7e8464eb17306de31695';
...
final class FavoriteMovieCommandFamily extends $Family
  ...
  FavoriteMovieCommandProvider call(int moiveId) =>
      FavoriteMovieCommandProvider._(argument: moiveId, from: this);
...
abstract class _$FavoriteMovieCommand extends $Notifier<bool> {
  ...
  int get moiveId => _$args;

  bool build(int moiveId);
  @$mustCallSuper
  @override
  void runBuild() {
